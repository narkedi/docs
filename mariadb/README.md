...
```console
$ docker run --name some-mariadb -e MYSQL_ROOT_PASSWORD=my-secret-pw -d amd64/mariadb:latest --character-set-server=utf8mb4 --collation-server=utf8mb4_unicode_ci
```
